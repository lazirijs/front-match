<template>
  <div class="grid gap-20 py-6">
    ...
    <div class="space-y-4">
      <btn-app v-if="$store.state.logged || $store.state.team == route.params.uid" text="الفريق" @click="$router.push(`/channel/team/${channel.uid}`)" icon="fluent:people-team-16-filled" class="min-w-fit mt-4 mx-auto" />
