<template>
    <div
        ...
        <input dir="rtl" :autocomplete="autocomplete" :name="name || label" class="w-full placeholder:tracking-normal placeholder:text-start truncate" :readonly="readonly" @:input="emits('update', $event.target.value)"
