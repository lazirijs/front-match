<template>
    <div
        class="w-full h-12 flex items-center bg-v rounded-v gap-[0.375rem] sm:gap-2 md:gap-3 px-2 sm:px-3 md:px-4 py-2 border-2 border-dashed dark:border-opacity-0 smooth"
        ...
        <input dir="auto" :autocomplete="autocomplete" :name="name || label" class="w-full placeholder:tracking-normal truncate" :readonly="readonly" @:input="emits('update', $event.target.value)"
